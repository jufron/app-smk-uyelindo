<div class="fixed bottom-10 right-8 z-[99]">
    ...
    <a href="https://wa.me/{{ $telepon_whatsapp ?? '+6281234567890' }}" target="_blank" class="bg-green-500 hover:bg-green-600 text-white px-4 py-3.5 rounded-md shadow-lg flex justify-center mt-4">
