<x-layouts.frond.app
    ...
    <section class="container mx-auto max-w-6xl px-4 py-10 my-20">
        ...
        <div class="flex justify-center mb-8" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
        ...
        <div class="md:columns-2 lg:columns-3 gap-6 p-4 sm:p-1 mt-2">
            ...
            <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="{{ $loop->index * 100 }}">
