<x-layouts.frond.app
    title="Login - Portal Siswa & Guru SMK Uyelindo Kupang"
    metaDescription="Masuk ke akun Anda untuk mengakses portal siswa dan guru SMK Uyelindo Kupang. Sistem informasi akademik yang mudah, cepat, dan aman."
    metaKeywords="Login SMK Uyelindo, Portal Siswa SMK, Portal Guru SMK, Akses Sistem Akademik, Login Sekolah Kupang"
    metaOgTitle="Login - SMK Uyelindo Kupang"
    metaOgDescription="Akses portal akademik SMK Uyelindo Kupang melalui halaman login ini. Untuk siswa, guru, dan staf sekolah."
    metaImage="{{ asset('assets/images/preview-login.jpg') }}"
    metaUrl="{{ url('/login') }}"
    metaTwitterTitle="Login Portal - SMK Uyelindo Kupang"
    metaTwitterDescription="Login ke Website profil SMK Uyelindo Kupang. Akses informasi pendidikan untuk siswa dan guru."
>

    <div class="min-h-screen bg-yellow-950 text-gray-900 flex justify-center">
        <div class="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
            <div class="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
                <div class="mx-auto flex justify-center">
                    <img 
                        src="{{ asset('img/logo.png') }}" 
                        alt="Logo SMK Uyelindo Kupang"
                        class="w-28" 
                        loading="lazy"
                    />
                </div>
                <div class="mt-5 flex flex-col items-center">
                    <div class="w-full flex-1 mt-8">
                        ...
                        <h1 class="text-center my-10 text-3xl font-bold">
                            Login
                        </h1>
                        ...
                        <form class="mx-auto max-w-xs mt-10 mb-20" action="{{ route('login') }}" method="POST">
                            ...
                            {{-- forgout passowrd route route('password.request') --}}

                            <button type="submit" class="mt-5 tracking-wide font-semibold bg-yellow-900 text-white w-full py-4 rounded-lg hover:bg-yellow-400 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
