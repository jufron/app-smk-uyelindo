<x-layouts.dashboard.app title="Ubah Berita">
    {{-- * my style --}}
    <x-slot:myStyle>
        {{-- ? summernote CSS  --}}
    ...
    <div class="card">
        ...
        <form action="{{ route('dashboard.berita.update', $berita) }}" method="post" enctype="multipart/form-data">
            @method('PATCH')
            @csrf
            <div class="card-body">
                <div class="col-md-5">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <x-dashboard.input-select label="Kategory" name="kategory_id">
                            ...
                            <option 
                                value="{{ $kat->id }}" 
                                @if (old('kategory_id', $berita->kategory_id) == $kat->id) 
                                selected 
