<x-layouts.dashboard.app title="Galeri Foto">
    {{-- * my style --}}
    <x-slot:myStyle>
        {{-- ? sweetalert 2 lib --}}
    ...
    {{-- todo content ... --}}
        ...
        <div class="card-body">
            ...
            <div class="my-4">
                <a href="{{ route('dashboard.galery-foto.create') }}" class="btn btn-success">Tambah</A>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table
                                ...
                                role="grid"
                                data-url="{{ route('dashboard.galery-foto.fetch') }}"
                                >
                                <thead>
                                    <tr role="row">
